...
#define _nstates6	30	/* alarm_button */
#define minseq6	215
#define maxseq6	243
#define _endstate6	29

#define _nstates5	7	/* temp_alarm */
#define minseq5	209
#define maxseq5	214
#define _endstate5	6

#define _nstates4	55	/* fsm_alarm */
#define minseq4	155
#define maxseq4	208
#define _endstate4	54

#define _nstates3	115	/* fsm_digit */
#define minseq3	41
#define maxseq3	154
#define _endstate3	114

#define _nstates2	12	/* light_button */
#define minseq2	30
#define maxseq2	40
#define _endstate2	11

#define _nstates1	7	/* temp_light */
#define minseq1	24
#define maxseq1	29
#define _endstate1	6

#define _nstates0	25	/* fsm_light */
#define minseq0	0
#define maxseq0	23
...
#define Palarm_button	((P6 *)this)
typedef struct P6 { /* alarm_button */
...
#define Ptemp_alarm	((P5 *)this)
typedef struct P5 { /* temp_alarm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_alarm	((P4 *)this)
typedef struct P4 { /* fsm_alarm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_digit	((P3 *)this)
typedef struct P3 { /* fsm_digit */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Plight_button	((P2 *)this)
typedef struct P2 { /* light_button */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Ptemp_light	((P1 *)this)
typedef struct P1 { /* temp_light */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_light	((P0 *)this)
typedef struct P0 { /* fsm_light */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned button_light : 1;
	unsigned button_alarm : 1;
	unsigned digit_out : 1;
	unsigned armed : 1;
	unsigned presence : 1;
	unsigned code_ok : 1;
	uchar state_light;
